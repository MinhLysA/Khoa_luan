...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{
        ...
        \textbf{Khóa luận này} & \textbf{10 kho song song} & \textbf{30} & \textbf{Có} & \textbf{M5 Walmart} & \textbf{IPPO} \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{enumerate}
    \item Khảo sát sâu cấu hình \textbf{10 kho song song thuần túy (non-multi-echelon)} với ràng buộc sức chứa kho dùng chung ở quy mô $300$ cặp kho--mặt hàng, tạo sự đối sánh rõ rệt với các mô hình đa cấp (multi-echelon) của MABIM \parencite{yang2023mabim} hay Liu và cộng sự \parencite{liu2025happo}.
    \item Đánh giá \textbf{ablation study tường minh} tác động của cơ chế chuẩn hóa phần thưởng phân rã cục bộ (local reward decomposition) kèm phạt ràng buộc fill rate cửa sổ trượt ở quy mô 300 tác tử, làm rõ cơ chế gán tín dụng và tốc độ hội tụ của IPPO.
