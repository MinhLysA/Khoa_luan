...
\begin{table}[htbp]
    ...
    \begin{tabular}{|p{3.0cm}|p{5.6cm}|p{4.8cm}|}
        ...
        Phần thưởng toàn cục & \texttt{reward\_mode: global} & Câu hỏi 3: cục bộ so với toàn cục \\ \hline
        Tắt chuẩn hóa theo cặp & \texttt{normalize\_reward\_per\_pair: false} & Câu hỏi 3: có/không chuẩn hóa \\ \hline
