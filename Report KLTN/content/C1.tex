...
2016\footnote{Các thống kê được tính từ hai tệp \texttt{calendar.csv} và
\texttt{sales\_train\_evaluation.csv} trong bộ dữ liệu M5 \parencite{m5dataset}.}.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|l|c|}
        ...
        \hline
        Chi phí lưu kho          & $c_{lk}$    & Tăng khi mức tồn kho cao \\ \hline
        Chi phí thiếu hàng       & $c_{th}$    & Tăng khi xảy ra hết hàng \\ \hline
        Chi phí đặt hàng cố định & $c_{dh}$    & Tăng theo tần suất đặt hàng \\ \hline
        Phạt tràn kho            & $p_{tk}$    & Tăng khi vượt sức chứa kho \\ \hline
...
không được mô hình hóa. Ở chiều ngược lại, khung làm việc của Jeong và cộng sự
...
\begin{enumerate}
    \item Câu hỏi 1: Tác tử IPPO có học được chính sách đặt hàng lại
    ...
    \item Câu hỏi 2: Cơ chế chia sẻ tham số giữa $300$ tác tử có đủ để
    học một chính sách tổng quát hóa được cho các mặt hàng có quy mô nhu cầu
    khác biệt đáng kể hay không?

    \item Câu hỏi 3: Hàm phần thưởng phân rã cục bộ kèm tỷ lệ đáp ứng
